...
class RolesHelperTest extends WebTestCase
{
    ...
    public function testContentTypes() {
        ...
        $this->assertEquals($roles::CLSS_STUDENT, 'ROLE_STUDENT', 'Test student role');
    ...
    public function testContentTypesList() {
        $roles = $this->serviceContainer->get('app.roles');
        $this->assertTrue(in_array($roles::CLSS_STUDENT, $roles::ROLES), 'Student role in list');
    ...
    public function testDisplayNames() {
        $roles = $this->serviceContainer->get('app.roles');
        $this->assertEquals($roles::ROLE_LABELS[$roles::CLSS_STUDENT][$roles::ROLE_LABEL_STANDARD], 'Student', 'Test student standard label');
